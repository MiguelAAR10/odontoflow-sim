...
import type { AppointmentView, AppointmentStatus, EvaluateInput, Rules } from "@/domain/engine";
...
describe("segundo recordatorio", () => {
  it("sale a 2 h de la cita si ya se recordó y no respondió", () => {
    ...
    expect(acts).toContainEqual({ type: "send_reminder", appointmentId: "a1", kind: "reminder_2h" });
  });
